...
The BusinessMath MCP server provides AI assistants with access to **195+ computational tools** across 40+ categories, **14 comprehensive resources**, and **6 guided workflow templates**. This enables powerful financial analysis through natural language.

### 🆕 What's New in v2.1

- **Financial Statement Construction**: Build complete income statements, balance sheets, and cash flow statements from account-level data (4 tools)
- **Operational Metrics**: Comprehensive SaaS and E-commerce KPI calculations including MRR, ARR, NRR, CAC, LTV, GMV, conversion rates (2 tools)
- **Capital Structure Analysis**: WACC, CAPM, cost of equity, beta levering/unlevering (2 tools)
- **Covenant Monitoring**: Debt covenant compliance tracking with headroom analysis and risk levels (1 tool)
- **Multi-Period Analysis**: Financial trend analysis, CAGR calculations, margin evolution (1 tool)
- **Advanced Financial Modeling**: Scenario analysis with base/upside/downside cases (1 tool)
- **Heuristic & Metaheuristic Optimization**: Particle Swarm Optimization, Genetic Algorithms, Simulated Annealing, Differential Evolution (4 tools)
- **Advanced Simulation**: Correlated Monte Carlo, GPU-accelerated simulations (2 tools)
- **Swift 6 Compliance**: Full concurrency support with @Sendable throughout all tools
...
**Financial Statement Construction** (4 tools):
- Create income statements from account-level data
- Create balance sheets with role-based classification
- Create cash flow statements (operating, investing, financing)
- Validate financial statements for consistency

**Operational Metrics** (2 tools):
- Calculate SaaS metrics (MRR, ARR, NRR, CAC, LTV, Magic Number, Quick Ratio, Burn Rate)
- Calculate E-commerce metrics (GMV, AOV, conversion rate, cart abandonment, customer metrics)

**Capital Structure Analysis** (2 tools):
- Calculate WACC with automatic CAPM cost of equity
- Calculate cost of equity using CAPM with beta levering/unlevering

**Covenant Monitoring** (1 tool):
- Monitor debt covenants with headroom analysis and risk levels

**Multi-Period Financial Analysis** (1 tool):
- Analyze financial trends across multiple periods with CAGR, margin evolution, and growth metrics

**Advanced Financial Modeling** (1 tool):
- Run scenario analysis (base/upside/downside) with sensitivity on key assumptions

**Heuristic Optimization** (2 tools):
- Particle Swarm Optimization (PSO) for complex optimization problems
- Genetic Algorithm (GA) for evolutionary optimization

**Metaheuristic Optimization** (2 tools):
- Simulated Annealing (SA) for global optimization with probabilistic acceptance
- Differential Evolution (DE) for population-based optimization

**Advanced Simulation** (2 tools):
- Correlated Monte Carlo simulation with correlation matrices
- GPU-accelerated Monte Carlo for high-performance simulation
...
### v2.1.0 - Financial Modeling & Advanced Optimization (2026-02-12)
- ✨ Added Financial Statement Construction tools (4 tools)
- ✨ Added Operational Metrics tools (2 tools) for SaaS and E-commerce KPIs
- ✨ Added Capital Structure Analysis tools (2 tools)
- ✨ Added Covenant Monitoring tool with headroom analysis
- ✨ Added Multi-Period Financial Analysis tool
- ✨ Added Advanced Financial Modeling tool for scenario analysis
...
- 🔧 Fixed Swift 6 concurrency warnings across all statistical tools
- 📈 Total tools increased from 172 → 195+ tools

### v2.0.0 - Mean-Variance Portfolio & Scenario Analysis (2025-12-26)
- ✨ Mean-Variance Portfolio Optimization with realistic constraints
- ✨ Discrete Scenario Analysis with mixed deterministic/probabilistic inputs
- ✨ Enhanced Integer Programming with solver selection and variable strategies
