...
**Location:** `project/summaries/` or `project/summaries/fixes/` for bug fixes
...
*Run `quality-gate` and verify all checks pass before ending the session.*
...
- [ ] If feature shipped: Moved to `project/checklists/completed/`
- [ ] `project/master_plan.md`: Updated if architectural changes were made
