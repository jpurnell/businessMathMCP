...
```bash
swift development-guidelines/setup.swift   # generates CLAUDE.md and .claude/
```

### Set up CI (per-project)

See [ci_quality_gate.md](ci_quality_gate.md).
...
- [Session Workflow](session_workflow.md) — Context recovery and handover protocol
- [Coding Rules](coding_rules.md) — Full coding standards
- [CI Quality Gate](ci_quality_gate.md) — Reusable CI workflow
- [TDD Contract](test_driven_development.md) — Testing standards
