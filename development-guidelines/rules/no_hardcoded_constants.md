...
- [Coding Rules](coding_rules.md) — General code style and safety
- [Design Proposal](design_proposal.md) — Architecture validation phase
- [Architecture Decisions](architecture_decisions.md) — Decision log
